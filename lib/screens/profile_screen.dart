...
import 'package:login_dash_animation/models/meal.dart';
import 'package:login_dash_animation/screens/workout_screen.dart';
...
class _RadialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Offset center = Offset(size.width / 1.8, size.height /3);
