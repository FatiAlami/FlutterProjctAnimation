  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: <Widget>[
          Image.asset("assets/images/full.jpg", fit: BoxFit.cover),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                  FadeAnimation(2.4,Text("Welcomme to Training And diet App", style: TextStyle(
                  color: Colors.white,
                  fontSize: 22,
                  letterSpacing: 2
                ))),
                FadeAnimation(2.6,Text("It is time to work", style: TextStyle(
                  color: Colors.white,
                  fontSize: 50,
